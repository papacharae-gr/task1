...
function Home() {
  ...
  // Αποφάσισε πόσα destinations να δείξεις
  const displayedDestinations = search 
    ? filteredDestinations // Όλα τα αποτελέσματα αν ψάχνει
    : filteredDestinations.slice(0, 3); // Μόνο τα top 3 αν δεν ψάχνει
      ...
      <Box>
        ...
        <Box px={{ base: 4, md: 10 }} py={10}>
          <Heading size="lg" mb={4} color="blue.500">
            {search ? `Search Results (${displayedDestinations.length})` : 'Popular Destinations'}
          </Heading>
